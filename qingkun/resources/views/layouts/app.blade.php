...
<head>
    ...
    <link href="{{ asset('css/common/webuploader.css') }}" rel="stylesheet">
...
<body>
<div id="app">
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #1a242f">
        <div class="container">
...
<script>
    tpwidget("init", {
        ...
        "color": "#C6C6C6",
        "uid": "U4954D65B6",
        "hash": "808708341018fd50da0a41c2a507cf4a"
    });
    tpwidget("show");
</script>
