...
@section('stylesheet')
    ...
    <link href="{{ asset('css/front/project.css') }}" rel="stylesheet">
@endsection
...
@section('content')
    <div class="main">
        ...
        <div id="project-view" class="row row-card">
            ...
            <div>
                <div class="card mb-3">
                    <a class="card-main" href="{{ url('/test/projectDetail') }}">
                        <div class="card-top">
                ...
                <div class="card mb-3">
                    <a class="card-main" href="#">
                        <div class="card-top">
                            <img class="card-img" style="height: 200px; width: 100%; display: block;"
                                 src="https://qingkun-img.oss-cn-hangzhou.aliyuncs.com/banner/burjkhalifa_1400x650.jpg"
                                 alt="Card image">
                        </div>
