    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/test') }}" style="color:#000000;">
            ...
            <div class="collapse navbar-collapse" id="navbarColor03">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/test') }}">首页</a>
                    </li>
                    <li class="nav-item">
                        <a id="project-link" class="nav-link" href="{{ url('/test/project') }}">项目</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/test/employee') }}">专家</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/test/about') }}">关于</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/test/job') }}">招聘</a>
                    </li>
                </ul>
