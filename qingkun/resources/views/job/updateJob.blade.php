                    ...
                    <div class="panel-body custom-panel-body">
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('job') ? ' has-error' : '' }}">
                                <label for="job" class="col-md-4 control-label">职位名称(选填)</label>

                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="job"
                                           value="{{ $job['job'] }}" placeholder="请输入职位名称" required>
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="department" type="text" class="form-control" name="department"
                                           value="{{ $job['department'] }}" placeholder="请输入部门"
                                    >
                            ...
                            <div class="form-group{{ $errors->has('introduction') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="simditor" type="text" class="form-control" name="introduction"
                                            placeholder="请输入岗位介绍" >{{ $job['introduction'] }}
                                        </textarea>
                            ...
                            <div class="form-group{{ $errors->has('requirement') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="simditorP" type="text" class="form-control" name="requirement"
                                            placeholder="请输入岗位要求" >{{ $job['requirement'] }}
                                        </textarea>
