                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name"
                                           value="{{ $news['name'] }}" placeholder="请输入标题" >
                            ...
                            <div class="form-group{{ $errors->has('photo') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="photo" type="text" class="form-control" name="photo"
                                           value="{{ $news['photo'] }}" placeholder="请输入图片链接" >
                            ...
                            <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="time" type="text" class="form-control" name="time"
                                           value="{{ $news['time'] }}" placeholder="请输入时间" >
                            ...
                            <div class="form-group{{ $errors->has('introduction') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-11">
                                    <textarea id="simditor" type="text" class="form-control" name="introduction"
                                            placeholder="请输入正文" >{{ $news['introduction'] }}
                                        </textarea>
